...
public class RatingControllerTest {
    ...
    public void testPage() throws Exception {
        ...
        when(mockRatingService.getPage(PageRequest.of(0, 1))).thenReturn(ratingPage);
    ...
    public void testPage_RatingServiceReturnsNoItems() throws Exception {
        // Setup
        when(mockRatingService.getPage(PageRequest.of(0, 1))).thenReturn(new PageImpl<>(Collections.emptyList()));
    ...
    public void testValidate() throws Exception {
        ...
        assertThat(response.getStatus()).isEqualTo(HttpStatus.OK.value());
        assertThat(response.getContentAsString()).isEqualTo(response.getContentAsString());
        verify(mockRatingService).save(any(Rating.class));
    }
    ...
    public void testShowUpdateForm() throws Exception {
        ...
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(get("/rating/update/{id}", 0)
                        .accept(MediaType.TEXT_HTML))
                .andReturn().getResponse();
    ...
    public void testUpdateRating() throws Exception {
        // Setup
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(post("/rating/update/{id}")
                        .param("id", "0")
                        .param("moodysRating", "moodysRating")
                        .param("sandpRating", "sandpRating")
                        .param("fitchRating", "fitchRating")
        ...
        assertThat(response.getStatus()).isEqualTo(HttpStatus.OK.value());
        assertThat(response.getContentAsString()).isEqualTo(response.getContentAsString());
        verify(mockRatingService).update(any(Rating.class));
    }
    ...
    public void testDeleteRating() throws Exception {
        // Setup
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(get("/rating/delete/{id}", 0)
                        .accept(MediaType.TEXT_HTML))
                .andReturn().getResponse();
        ...
        assertThat(response.getStatus()).isEqualTo(HttpStatus.OK.value());
        assertThat(response.getContentAsString()).isEqualTo(response.getContentAsString());
        verify(mockRatingService).delete(0);
    }
}
