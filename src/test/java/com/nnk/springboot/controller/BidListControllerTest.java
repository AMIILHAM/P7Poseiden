...
public class BidListControllerTest {
    ...
    public void testPage() throws Exception {
        ...
        when(mockBidListService.getAllBidList(PageRequest.of(0, 1))).thenReturn(bidLists);
    ...
    @Test
    public void testPage_BidListServiceReturnsNoItems() throws Exception {
        // Setup
        when(mockBidListService.getAllBidList(PageRequest.of(0, 1)))
    ...
    @Test
    public void testShowUpdateForm_BidListServiceReturnsAbsent() throws Exception {
        // Setup
        when(mockBidListService.findById(0)).thenReturn(Optional.empty());
    ...
    public void testUpdateBid() throws Exception {
        ...
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(post("/bidList/update/{id}")
                        .param("bidListId", "0")
                        .param("account", "account")
                        .param("type", "type")
                        .param("bidQuantity", "0")
        ...
        assertThat(response.getStatus()).isEqualTo(HttpStatus.OK.value());
        assertThat(response.getContentAsString()).isEqualTo(response.getContentAsString());
        verify(mockBidListService).update(any(BidList.class));
    }
    ...
    public void testDeleteBid() throws Exception {
        ...
        assertThat(response.getStatus()).isEqualTo(HttpStatus.OK.value());
        assertThat(response.getContentAsString()).isEqualTo(response.getContentAsString());
        verify(mockBidListService).delete(0);
    }
}
