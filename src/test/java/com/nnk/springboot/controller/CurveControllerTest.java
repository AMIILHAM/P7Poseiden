...
public class CurveControllerTest {
    ...
    public void testPage() throws Exception {
        ...
        when(mockCurvePointService.getPage(PageRequest.of(0, 1))).thenReturn(curvePointPage);
    ...
    public void testPage_CurvePointServiceReturnsNoItems() throws Exception {
        // Setup
        when(mockCurvePointService.getPage(PageRequest.of(0, 1))).thenReturn(new PageImpl<>(Collections.emptyList()));
    ...
    public void testValidate() throws Exception {
        ...
        verify(mockCurvePointService).save(curvePointDto);
    }


    @Test
    public void testValidate_CurvePointServiceGetPageReturnsNoItems() throws Exception {
        // Setup
        when(mockCurvePointService.getPage(PageRequest.of(0, 1))).thenReturn(new PageImpl<>(Collections.emptyList()));
    ...
    public void testShowUpdateForm() throws Exception {
        ...
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(get("/curvePoint/update/{id}", 0)
                        .accept(MediaType.TEXT_HTML))
                .andReturn().getResponse();
    ...
    public void testUpdateCurvePoint() throws Exception {
        // Setup
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(post("/curvePoint/update/{id}")
                        .param("id", "0")
                        .param("term", "0")
                        .param("value", "0")
                        .with(csrf())
        ...
        curvePointDto.setTerm(0.0);
        curvePointDto.setValue(0.0);
        verify(mockCurvePointService).update(curvePointDto);
    }
    ...
    public void testDeleteCurvePoint() throws Exception {
        // Setup
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(get("/curvePoint/delete/{id}", 0)
                        .accept(MediaType.TEXT_HTML))
                .andReturn().getResponse();
        ...
        assertThat(response.getStatus()).isEqualTo(HttpStatus.OK.value());
        assertThat(response.getContentAsString()).isEqualTo(response.getContentAsString());
        verify(mockCurvePointService).delete(0);
    }
}
