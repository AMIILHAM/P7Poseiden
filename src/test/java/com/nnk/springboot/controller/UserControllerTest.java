...
public class UserControllerTest {
    ...
    public void testPage_AppUserServiceReturnsNoItems() throws Exception {
        // Setup
        when(mockAppUserService.appUserPage(PageRequest.of(0, 1))).thenReturn(new PageImpl<>(Collections.emptyList()));
    ...
    public void testValidate() throws Exception {
        ...
        final Page<AppUser> appUserPage = new PageImpl<>(
                List.of(new AppUser(0, "username", "password", "fullname", "role")));
        when(mockAppUserService.appUserPage(PageRequest.of(0, 1))).thenReturn(appUserPage);
        ...
        assertThat(response.getStatus()).isEqualTo(HttpStatus.OK.value());
        assertThat(response.getContentAsString()).isEqualTo(response.getContentAsString());
        verify(mockAppUserService).save(any(AppUser.class));
    }

    @Test
    public void testValidate_AppUserServiceSaveThrowsServiceException() throws Exception {
        // Setup
        when(mockAppUserService.save(any(AppUser.class))).thenThrow(ServiceException.class);
    ...
    @Test
    public void testValidate_AppUserServiceAppUserPageReturnsNoItems() throws Exception {
        // Setup
        when(mockAppUserService.appUserPage(PageRequest.of(0, 1))).thenReturn(new PageImpl<>(Collections.emptyList()));
    ...
    public void testShowUpdateForm() throws Exception {
        ...
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(get("/user/update/{id}", 0)
                        .accept(MediaType.TEXT_HTML))
                .andReturn().getResponse();
    ...
    public void testUpdateUser() throws Exception {
        ...
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(post("/user/update/{id}", 0)
                        .param("id", "0")
                        .param("username", "username")
                        .param("password", "password")
                        .param("fullname", "fullname")
        ...
        assertThat(response.getStatus()).isEqualTo(HttpStatus.OK.value());
        assertThat(response.getContentAsString()).isEqualTo(response.getContentAsString());
        verify(mockAppUserService).update(any(AppUser.class));
    }

    @Test
    public void testUpdateUser_AppUserServiceUpdateThrowsServiceException() throws Exception {
        // Setup
        when(mockAppUserService.update(any(AppUser.class))).thenThrow(ServiceException.class);
    ...
    @Test
    public void testUpdateUser_AppUserServiceAppUserPageReturnsNoItems() throws Exception {
        // Setup
        when(mockAppUserService.appUserPage(PageRequest.of(0, 1))).thenReturn(new PageImpl<>(Collections.emptyList()));
    ...
    public void testDeleteUser() throws Exception {
        ...
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(get("/user/delete/{id}", 0)
                        .param("page", "0")
                        .param("size", "0")
                        .with(user("username"))
                        .accept(MediaType.TEXT_HTML))
        ...
        assertThat(response.getStatus()).isEqualTo(HttpStatus.OK.value());
        assertThat(response.getContentAsString()).isEqualTo(response.getContentAsString());
        verify(mockAppUserService).deleteUser(0);
    }
