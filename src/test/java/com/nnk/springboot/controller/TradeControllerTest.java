...
public class TradeControllerTest {
    ...
    public void testPage() throws Exception {
        ...
        when(mockTradeService.getPage(PageRequest.of(0, 1))).thenReturn(trades);
    ...
    public void testPage_TradeServiceReturnsNoItems() throws Exception {
        // Setup
        when(mockTradeService.getPage(PageRequest.of(0, 1))).thenReturn(new PageImpl<>(Collections.emptyList()));
    ...
    public void testValidate_TradeServiceGetPageReturnsNoItems() throws Exception {
        ...
        assertThat(response.getStatus()).isEqualTo(HttpStatus.OK.value());
        assertThat(response.getContentAsString()).isEqualTo(response.getContentAsString());
        verify(mockTradeService).save(any(Trade.class));
    }
    ...
    public void testShowUpdateForm() throws Exception {
        ...
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(get("/trade/update/{id}", 0)
                        .accept(MediaType.TEXT_HTML))
                .andReturn().getResponse();
    ...
    public void testUpdateTrade() throws Exception {
        ...
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(post("/trade/update/{id}")
                        .param("tradeId", "0")
                        .param("account", "account")
                        .param("type", "type")
                        .param("buyQuantity", "0")
    ...
    public void testDeleteTrade() throws Exception {
        // Setup
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(get("/trade/delete/{id}", 0)
                        .accept(MediaType.TEXT_HTML))
                .andReturn().getResponse();
        ...
        assertThat(response.getStatus()).isEqualTo(HttpStatus.OK.value());
        assertThat(response.getContentAsString()).isEqualTo(response.getContentAsString());
        verify(mockTradeService).delete(0);
    }
}
