...
public class RuleNameControllerTest {
    ...
    public void testPage_RuleNameServiceReturnsNoItems() throws Exception {
        // Setup
        when(mockRuleNameService.getPage(PageRequest.of(0, 1))).thenReturn(new PageImpl<>(Collections.emptyList()));
    ...
    public void testValidate() throws Exception {
        ...
        assertThat(response.getStatus()).isEqualTo(HttpStatus.OK.value());
        assertThat(response.getContentAsString()).isEqualTo(response.getContentAsString());
        verify(mockRuleNameService).save(any(RuleName.class));
    }
    ...
    public void testShowUpdateForm() throws Exception {
        ...
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(get("/ruleName/update/{id}", 0)
                        .accept(MediaType.TEXT_HTML))
                .andReturn().getResponse();
    ...
    public void testUpdateRuleName() throws Exception {
        ...
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(post("/ruleName/update/{id}")
                        .param("id", "0")
                        .param("name", "name")
                        .param("description", "description")
                        .param("json", "json")
        ...
        assertThat(response.getStatus()).isEqualTo(HttpStatus.OK.value());
        assertThat(response.getContentAsString()).isEqualTo(response.getContentAsString());
        verify(mockRuleNameService).update(any(RuleName.class));
    }
    ...
    public void testDeleteRuleName() throws Exception {
        // Setup
        // Run the test
        final MockHttpServletResponse response = mockMvc.perform(get("/ruleName/delete/{id}", 0)
                        .accept(MediaType.TEXT_HTML))
                .andReturn().getResponse();
        ...
        assertThat(response.getStatus()).isEqualTo(HttpStatus.OK.value());
        assertThat(response.getContentAsString()).isEqualTo(response.getContentAsString());
        verify(mockRuleNameService).delete(0);
    }
}
